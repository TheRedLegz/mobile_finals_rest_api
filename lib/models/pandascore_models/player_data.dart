...
List<PlayerData> playerDataListFromJson(String str) => List<PlayerData>.from(json.decode(str).map((x) => PlayerData.fromJson(x)));
List<PlayerData> playerDataListFromJsonObject(List<Map<String, dynamic>> jsonObject) => List<PlayerData>.from(jsonObject.map((x) => PlayerData.fromJson(x)));

String playerDataToJson(List<PlayerData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
